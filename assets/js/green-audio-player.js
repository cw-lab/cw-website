            ...
            var GreenAudioPlayer = /*#__PURE__*/ function() {
                ...
                _createClass(GreenAudioPlayer, [{
                    ...
                    value: function pausePlayer(player) {
                        var playPauseButton = player.parentElement.querySelector('#audio__play');
                        playPauseButton.attributes.class.value = 'audio__play icon icon-play-solid';
                        player.pause();
                    }
                }, {
                    key: "playPlayer",
                    value: function playPlayer(player) {
                        var playPauseButton = player.parentElement.querySelector('#audio__play');
                        playPauseButton.attributes.class.value = 'audio__play icon icon-pause-solid';
                        player.play();
                    }
                }, {

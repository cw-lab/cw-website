...
WebFontConfig = {
  google: {
    families: [
      ...
      "Noto Serif TC:200,300,400,500,600,700",
...
$(function () {
  ...
  if (width < 1024) {
    $(".channel__title").click(function () {
      ...
      $(this)
        .parent()
        .siblings(".channel__item")
        .children(".channel__title")
        .children("i.icon")
        .removeClass("active");
      $(this)
        .parent()
        .siblings(".channel__item")
        .children(".channel__option")
        .slideUp();
    });
  }
  ...
  $(
    ".menubar__user > i.icon, .menubar__user .menubar__user--member, .opacity"
  ).click(function () {
  ...
  $(window).on("load", function () {
    ...
    // 判斷有沒有值
    $("input.form__group__input, textarea.form__group__textarea").each(
      function () {
        if (this.value) {
    ...
    function input() {
      ...
      $("input.form__group__input[disabled]")
        .parent()
        .removeClass("form__group--defalt")
        .addClass("form__group--disabled");
      $("textarea.form__group__textarea")
        .parent()
        .addClass("form__group--defalt");
      $("textarea.form__group__textarea[disabled]")
        .parent()
        .removeClass("form__group--defalt")
        .addClass("form__group--disabled");
    }
    ...
    function select() {
      ...
      $("select[disabled]")
        .parent()
        .removeClass("select__group--defalt")
        .addClass("select__group--disabled");
    }
    input();
    select();
    $("input.form__group__input, textarea.form__group__textarea").change(
      function () {
        input();
      }
    );
    ...
    function tabNavWidth(width) {
      $(".tab").each(function () {
        ...
        if (width >= 768) {
          ...
          $(this)
            .children(".click-right")
            .click(function () {
              $(this)
                .siblings(".tab__nav")
                .children("ul")
                .animate({ left: "-=" + 140 * scrollWidth }, function () {
    ...
    $("nav.menubar--belt").each(function () {
      $(this)
        ...
        .css({
          width:
            $(this).outerWidth() / $(this).children().children().length + "px",
        });
    });
    // sidemenu-left
    $(
      ".menubar--left > ul > li > .li__group > i.more, .menubar__user--member > ul > li > .li__group > i.more"
    ...
    // }, 10);
    // 字體大小放大縮小
    (fzLevel = 0), (fzClass = "article__level--" + fzLevel);
    ...
    $(".accordion__group .accordion__item__header").on("click", function () {
      ...
      $(this)
        .parent()
        .siblings()
        .children(".accordion__item__header")
        .removeClass("active");
      $(this)
        .parent()
        .siblings()
    ...
    // 全閱讀 secant project
    var rightHeights = $(".plan__item .plan__item__right")
      .map(function () {
    ...
    $(window).scroll(function () {
      var scroll = $(window).scrollTop(),
        ...
        storyLineH = $(".storyLine").outerHeight();
      if (
        width < 1024 &&
        $(".menubar__user--member").is(":visible") &&
        scroll >= adFirstHeight
      ) {
        $("body").addClass("opened");
      } else {
        $("body").removeClass("opened");
      ...
      if (scroll >= adFirstHeight) {
        ...
        $(".storyLine").addClass("fixed");
      } else {
        $("header").removeClass("fixed");
        $("body").css({
          "padding-top": 0,
        });
        $(".storyLine").removeClass("fixed");
      }
    });
